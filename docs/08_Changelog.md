...
- **Interactive Certificate Lightbox Viewer**:
  - Extracted the first page of the ICTIS 2023 paper publication certificate PDF using `pdftoppm` and compressed it into a WebP image (`public/static/images/ictis-paper-publication-2023.webp`) using Pillow.
  - Configured the "AI Music Melody Generation System" project inside **[projects.json](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/data/projects.json)** to link directly to this optimized certificate WebP image.
  - Refactored **[CaseStudyPresenter.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/organisms/CaseStudyPresenter.tsx)** to open the certificate WebP image inside the native, auto-resizing **[ImageLightbox.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/molecules/ImageLightbox.tsx)** component, resolving browser margins and iframe download prompt issues.
  - Updated **[ProjectLinksGroup.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/molecules/ProjectLinksGroup.tsx)** to support the interactive click event handler.
