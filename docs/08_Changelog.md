...
- **Interactive PDF Lightbox Viewer**:
  - Developed a custom, responsive **[PdfLightbox.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/molecules/PdfLightbox.tsx)** component leveraging Framer Motion backdrop overlays and inline iframe renders to prevent forced browser downloads.
  - Added native download and new-tab controls in the lightbox toolbar, along with a custom mobile warning and open-link button layout for mobile viewports.
  - Linked the ICTIS 2023 publication certificate PDF (`public/ictis-paper-publication-2023.pdf`) to the AI Music Melody Generation project inside **[projects.json](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/data/projects.json)**.
  - Updated **[ProjectLinksGroup.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/molecules/ProjectLinksGroup.tsx)** and **[CaseStudyPresenter.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/organisms/CaseStudyPresenter.tsx)** to support certificate URL parameters, render them with a document icon (`FiFileText`), and trigger the lightbox modal on click.
- **Performance & Asset Formats Optimization**:
  ...
  - Cleaned up the static assets space by permanently deleting 23 legacy duplicate PNG screenshots from the repository.
