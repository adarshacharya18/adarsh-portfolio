...
- **Robust Link Rendering & Structured Schemas**:
  ...
  - Extended the `ProjectItem` interface in **[project.ts](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/types/project.ts)** to support structured feature showcases, and updated **[CaseStudyPresenter.tsx](file:///home/adarsh/Documents/Portpolio_website/Website_2026/src/components/organisms/CaseStudyPresenter.tsx)** to render dynamic screenshots galleries with text descriptions mapped in browser-styled frame cards for both the Motorcycle Safety Academy and the Enterprise E-Signature Platform projects.
